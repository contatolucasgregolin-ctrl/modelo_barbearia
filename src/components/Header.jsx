            ...
            <div className="container header-content" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative' }}>
                ...
                <div style={{ flex: 1, display: 'flex', justifyContent: 'center', overflow: 'hidden' }}>
                    {siteData.logo ? (
                        ...
                        <h2 style={{ margin: 0, fontFamily: 'Montserrat, sans-serif', fontSize: 'clamp(1rem, 3vw, 1.5rem)', fontWeight: 800, letterSpacing: '-1px', color: 'var(--color-primary)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
